    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '24px' }}>
            <h1 style={{ margin: '0 0 4px', fontSize: '24px', color: '#18181b', fontFamily: "'Playfair Display', serif", fontWeight: 600 }}>
              Welcome <span style={{ fontStyle: 'italic', color: '#52525b', fontWeight: 600 }}>back</span>
            </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                <label style={{ fontSize: '12px', fontWeight: 500, color: '#3f3f46' }}>
                  Password
                </label>
                <a href="/forgot-password" style={{ fontSize: '11px', color: '#a1a1aa', textDecoration: 'none', fontWeight: 400 }}>
                  Forgot password?
                </a>
              </div>
        ...
        <div style={{ marginTop: '24px', textAlign: 'center', fontSize: '12px', color: '#71717a' }}>
          Don't have an account? <Link to="/signup" style={{ color: '#18181b', textDecoration: 'none', fontWeight: 500, borderBottom: '1px solid #d4d4d8', paddingBottom: '1px' }}>Sign up free</Link>
        </div>
      </div>
    </>
  );
